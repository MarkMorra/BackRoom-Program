...
public:
	...
	//g = generic, p = price change, a = amount change, n = new item/remove item, l = login/logout, i = item information changes (eg the description was changed), u = user information change, m = new user added
